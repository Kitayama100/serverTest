...
class GetSubjectsController extends BaseController_1.BaseController {
    constructor(getSubjectsUseCase) {
        super();
        this.versionRegister.default = "1.0.0";
        this.versionRegister.addToRegister("1.0.0", (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield getSubjectsUseCase.execute();
                if (response.isLeft()) {
...
//# sourceMappingURL=getSubjectsController.js.map